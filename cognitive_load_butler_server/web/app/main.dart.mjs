...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1309: (x0,x1) => x0.getAttribute(x1),
      ...
      _1472: () => new AbortController(),
      _1473: x0 => x0.abort(),
      _1474: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1475: (x0,x1) => globalThis.fetch(x0,x1),
      _1476: (x0,x1) => x0.get(x1),
      _1477: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1477(f,arguments.length,x0,x1,x2) }),
      _1478: (x0,x1) => x0.forEach(x1),
      ...
      _1498: x0 => x0.trustedTypes,
      _1499: (x0,x1) => { x0.src = x1 },
      _1500: (x0,x1) => x0.createScriptURL(x1),
      _1501: x0 => x0.nonce,
      _1502: (x0,x1) => x0.debug(x1),
      _1503: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1503(f,arguments.length,x0) }),
      _1504: x0 => ({createScriptURL: x0}),
      _1505: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1506: (x0,x1) => x0.appendChild(x1),
      _1507: (x0,x1) => x0.querySelectorAll(x1),
      _1517: (s, m) => {
        try {
      ...
      _1709: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1710: f => finalizeWrapper(f, function() { return dartInstance.exports._1710(f,arguments.length) }),
      _2036: (x0,x1) => { x0.nonce = x1 },
      _3074: (x0,x1) => { x0.src = x1 },
      _3080: (x0,x1) => { x0.async = x1 },
      _3082: (x0,x1) => { x0.defer = x1 },
      _3543: () => globalThis.window,
      _3584: x0 => x0.document,
      _3861: x0 => x0.isSecureContext,
      _3864: x0 => x0.crypto,
      _3868: x0 => x0.trustedTypes,
