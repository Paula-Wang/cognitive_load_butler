...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.TaskFocus) {
      return _i7.TaskFocus.fromJson(data) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'TaskFocus') {
      return deserialize<_i7.TaskFocus>(data['data']);
    }
  ...
  @override
  String getModuleName() => 'cognitive_load_butler';
}
