...
class TaskUpdateTable extends _i1.UpdateTable<TaskTable> {
  ...
  _i1.ColumnValue<int, int> importance(int value) => _i1.ColumnValue(
    table.importance,
    value,
  );

  _i1.ColumnValue<int, int> mentalLoad(int value) => _i1.ColumnValue(
    table.mentalLoad,
    value,
  );
  ...
  _i1.ColumnValue<bool, bool> flexible(bool value) => _i1.ColumnValue(
    table.flexible,
    value,
  );
}
...
class TaskTable extends _i1.Table<int?> {
  TaskTable({super.tableRelation}) : super(tableName: 'task') {
    ...
    importance = _i1.ColumnInt(
      'importance',
      this,
    );
    mentalLoad = _i1.ColumnInt(
      'mentalLoad',
      this,
    );
  ...
  late final _i1.ColumnInt importance;

  late final _i1.ColumnInt mentalLoad;

  late final _i1.ColumnDateTime deadline;

  late final _i1.ColumnBool flexible;
